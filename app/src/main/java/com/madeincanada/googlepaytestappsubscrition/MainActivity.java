package com.madeincanada.googlepaytestappsubscrition;
...
import com.madeincanada.googlepaytestappsubscrition.util.IabBroadcastReceiver;
import com.madeincanada.googlepaytestappsubscrition.util.IabHelper;
import com.madeincanada.googlepaytestappsubscrition.util.IabResult;
import com.madeincanada.googlepaytestappsubscrition.util.Inventory;
import com.madeincanada.googlepaytestappsubscrition.util.Purchase;

import java.util.ArrayList;
import java.util.List;

import static com.madeincanada.googlepaytestappsubscrition.Constants.SKU_DELAROY_MONTHLY;
import static com.madeincanada.googlepaytestappsubscrition.Constants.SKU_DELAROY_SIXMONTH;
import static com.madeincanada.googlepaytestappsubscrition.Constants.SKU_DELAROY_THREEMONTH;
import static com.madeincanada.googlepaytestappsubscrition.Constants.SKU_DELAROY_YEARLY;
import static com.madeincanada.googlepaytestappsubscrition.Constants.base64EncodedPublicKey;
...
public class MainActivity extends AppCompatActivity implements IabBroadcastReceiver.IabBroadcastListener,
    ...
    // Does the user have an active subscription to the incomeTax plan?
    ...
    IabHelper.OnIabPurchaseFinishedListener mPurchaseFinishedListener = new IabHelper.OnIabPurchaseFinishedListener() {
        public void onIabPurchaseFinished(IabResult result, Purchase purchase) {
            ...
            if (purchase.getSku().equals(SKU_DELAROY_MONTHLY)
                ...
                Log.d(TAG, "IncomeTax subscription purchased.");
                alert("Thank you for subscribing to IncomeTax!");
    ...
    void complain(String message) {
        Log.e(TAG, "**** IncomeTax Error: " + message);
        alert("Error: " + message);
    }
